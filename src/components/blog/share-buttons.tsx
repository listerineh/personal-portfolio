  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem onClick={shareOnTwitter} className="cursor-pointer hover:bg-blue-500/10">
        ...
        <DropdownMenuItem onClick={shareOnLinkedIn} className="cursor-pointer hover:bg-blue-600/10">
          <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <DropdownMenuItem onClick={shareOnFacebook} className="cursor-pointer hover:bg-blue-700/10">
          <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
